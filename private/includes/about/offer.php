...
<!-- Quality Materials -->
        <div>
            <!-- Simon: Todo: Make Quality Materials 100% Width -->
            <img src="/images/icons/credibility.svg" alt="" style="aspect-ratio: <?php svg_ratio('/images/icons/credibility.svg'); ?>">
...
<!-- Design Proof -->
        <div>
            <img src="/images/icons/approval.svg" alt="" style="aspect-ratio: <?php svg_ratio('/images/icons/approval.svg'); ?>">
            <h3>Free Design Proof</h3>
...
<!-- Free Shipping -->
        <div>
            <img src="/images/icons/ship.svg" alt="" style="aspect-ratio: <?php svg_ratio('/images/icons/ship.svg'); ?>">
            <h3>Free Shipping</h3>
