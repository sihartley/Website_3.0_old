 ...
 */
//$id = $_GET['id'];
$graphicId = 331; //Simon: Note: ID317 model='Grand Cherokee' and year=2011
/**
...
$accentCut = [2, 5]; //Styles that have the Accent Cut-Out
...
$text = [1, 2, 4, 5]; $textRef = 'CUSTOM TEXT'; $textCut = [1, 2, 4, 5]; $textSame = [];
