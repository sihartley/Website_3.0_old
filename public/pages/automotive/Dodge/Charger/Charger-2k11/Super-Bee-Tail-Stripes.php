...
/* Graphics Options */
$accentStyles = [1, 4, 5]; //Styles that have an Accent
$accentCut = [5]; //Styles that have the Accent Cut-Out
$accentSame = [1, 4]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 4, 5, 6]; $textRef = 'Custom Text or Logo/TEXT HERE'; $textCut = [2, 4, 5]; $textSame = [1, 6];
$text2 = [1]; $text2Ref = 'Custom Text Here'; $text2Cut = [1]; $text2Same = [];
