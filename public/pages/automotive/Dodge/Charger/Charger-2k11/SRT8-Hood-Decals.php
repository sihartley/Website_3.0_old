...
/* Graphics Options */
$accentStyles = [5, 6, 7, 8, 9, 27, 28]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [5, 6, 7, 8, 9, 27, 28]; //Styles that have the accent Separate which can be the Same Color as Main
$accent2Styles = [2, 4, 6, 8, 9, 11, 13, 15, 17, 19, 24]; //Styles with a 2nd Accent
$accent2Cut = []; //Styles that have the 2nd Accent Cut-Out
$accent2Same = [2, 4, 6, 8, 9, 11, 13, 15, 17, 19];  //Styles that have the 2nd Accent Separate which can be the Same Color as Main
$text = [1, 2, 3, 4, 6, 7, 8, 9, 10, 11, 12, 13, 18, 19, 20, 21, 26]; $textRef = 'CUSTOM SIDE TEXT'; $textCut = [1, 2, 3, 4, 6, 7, 8, 10, 11, 12, 13, 20, 21, 26]; $textSame = [9, 18, 19];
$text2 = [1, 2, 4, 6, 8, 9, 11, 13, 15, 17, 19, 20, 23, 24]; $text2Ref = 'Custom Front Text'; $text2Cut = [1, 2, 4, 6, 8, 9, 11, 13, 15, 17, 19, 20, 23, 24]; $text2Same = [];
