...
/* Graphics Options */
$accentStyles = [3, 5, 6, 7, 8]; //Styles that have an Accent
$accentCut = [3, 5, 6, 8]; //Styles that have the Accent Cut-Out
$accentSame = [7]; //Styles that have the accent Separate which can be the Same Color as Main
