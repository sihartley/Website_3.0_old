...
/* Graphics Options */
$accentStyles = [2, 4, 6]; //Styles that have an Accent
$accentCut = [2, 4]; //Styles that have the Accent Cut-Out
...
$text = [1, 2, 3, 4]; $textRef = 'CUSTOM TEXT'; $textCut = [1, 2, 3, 4]; $textSame = [];
