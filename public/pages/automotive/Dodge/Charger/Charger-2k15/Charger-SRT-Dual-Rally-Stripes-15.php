...
/* Graphics Options */
$accentStyles = [1, 3, 4, 6, 7]; //Styles that have an Accent
                ...
                <?php formStart($design, $foxy_cart); ?>
                    ...
                    <!-- Vehicle Information Section (Year, Trim, Color) -->
                        <?php vehicleInformationStart(); ?>
                            ...
                            $trimSVGMod = 'b';
                            $trimMods = array(
                                ['trim' => 'R/T Scat Pack Widebody', 'price_mod' => $trimModPrice, 'image_mod' => $trimSVGMod],
                                ['trim' => 'Daytona 392 Widebody', 'price_mod' => $trimModPrice, 'image_mod' => $trimSVGMod],
                                ['trim' => 'SRT Hellcat Widebody', 'price_mod' => $trimModPrice, 'image_mod' => $trimSVGMod],
                                ['trim' => 'SRT Hellcat Daytona 50th Widebody', 'price_mod' => $trimModPrice, 'image_mod' => $trimSVGMod],
