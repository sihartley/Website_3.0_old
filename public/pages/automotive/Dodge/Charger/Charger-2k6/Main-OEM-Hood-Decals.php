...
/* Graphics Options */
$accentStyles = [3, 8]; //Styles that have an Accent
$accentCut = [3]; //Styles that have the Accent Cut-Out
$accentSame = [8]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4, 5, 6, 7, 8]; $textRef = 'CUSTOM TEXT'; $textCut = [1, 3, 5, 6, 7]; $textSame = [2, 4, 8];
$text2 = [5, 6, 7, 8]; $text2Ref = 'LOGO'; $text2Cut = [5, 6, 7, 8]; $text2Same = [];
