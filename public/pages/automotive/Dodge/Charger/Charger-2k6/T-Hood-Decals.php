...
/* Graphics Options */
$accentStyles = [4]; //Styles that have an Accent
...
$text = [1, 3, 4, 5, 6, 7]; $textRef = 'TEXT'; $textCut = [1, 4, 5, 6, 7]; $textSame = [3];
$text2 = [1, 2, 3, 4, 7, 8]; $text2Ref = 'LOGO'; $text2Cut = [1, 2, 3, 4]; $text2Same = [7, 8];
