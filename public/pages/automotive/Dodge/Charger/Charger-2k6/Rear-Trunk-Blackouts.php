...
$text = [1, 2]; $textRef = 'MAIN TEXT'; $textCut = [1, 2]; $textSame = [];
$text2 = [1, 2]; $text2Ref = 'LLTEXT'; $text2Cut = [1, 2]; $text2Same = [];
$text3 = [1, 2]; $text3Ref = 'LRTEXT'; $text3Cut = [1, 2]; $text3Same = [];
$trimData = null;
$trimData = array(
        'Emblem' => [
            'select' => [
                'name' => 'Emblem',
                'placeholder' => 'Pre-Cut for Dodge Emblem?'
            ],
            'options' => [
                'installed' => [
                    'text' => 'Yes, Pre-Cut for Emblem',
                    'specs' => 'Graphics will be produced to fit around the emblem.',
                    'image' => '',
                    'percentage' => 0,
                    'add sub' => ''
                ],
                'none' => [
                    'text' => 'No, Don\'t Pre-Cut for Dodge Emblem',
                    'specs' => 'Emblem will be removed to graphic installation',
                    'image' => '',
                    'percentage' => 0,
                    'add sub' => ''
                ]
