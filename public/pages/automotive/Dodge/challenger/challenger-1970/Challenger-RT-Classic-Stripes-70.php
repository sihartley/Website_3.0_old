...
$accentSame = [2, 4, 5, 6]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4, 5, 6]; $textRef = 'Front Fender TXT/LOGO'; $textCut = []; $textSame = [];
$text2 = [1, 2, 3, 4, 5, 6]; $text2Ref = 'Rear Quarter TXT/LOGO'; $text2Cut = []; $text2Same = [];
