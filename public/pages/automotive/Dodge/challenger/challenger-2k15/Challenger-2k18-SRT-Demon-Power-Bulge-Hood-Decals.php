...
/* Graphics Options */
$accentStyles = [2, 3, 4, 5, 8, 9, 10, 11, 12]; //Styles that have an Accent
$accentCut = [2, 3, 4, 5, 12]; //Styles that have the Accent Cut-Out
$accentSame = [8, 9, 10, 11]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [6]; $textRef = 'TXT/LOGO'; $textCut = [6]; $textSame = [];
