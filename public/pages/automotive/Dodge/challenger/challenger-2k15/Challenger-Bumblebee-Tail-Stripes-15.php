...
/* Graphics Options */
$accentStyles = [1, 2, 4, 5, 7, 8]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [1, 2, 4, 5, 7, 8]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 4, 5, 6, 7, 8]; $textRef = 'TEXT/LOGO'; $textCut = [1, 6, 8]; $textSame = [2, 4, 5, 7];
$text2 = [4]; $text2Ref = 'SIDE TXT/LOGO'; $text2Cut = [4]; $text2Same = [];
