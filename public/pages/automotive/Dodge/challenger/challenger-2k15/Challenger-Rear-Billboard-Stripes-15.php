...
$text = [1, 4, 5, 7, 8, 9, 10, 11, 15]; $textRef = 'Door TEXT'; $textCut = [1, 4, 5, 7, 8, 9, 11, 15]; $textSame = [7, 8, 9, 10];
$text2 = [5, 12, 13, 14]; $text2Ref = 'Rear Qtr TEXT'; $text2Cut = [5, 12, 13, 14]; $text2Same = [];
