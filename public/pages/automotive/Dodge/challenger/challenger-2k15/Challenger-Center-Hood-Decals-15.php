 ...
 */
//$id = $_GET['id'];
$graphicId = 212; //Simon: Note: ID174 model='challenger' and year=2015
/**
...
/* Graphics Options */
$accentStyles = [2, 3, 4, 5]; //Styles that have an Accent
$accentCut = [3, 4, 5]; //Styles that have the Accent Cut-Out
...
$text = [1, 2, 3, 4, 6]; $textRef = 'CUSTOM TEXT LOGO'; $textCut = [2, 3, 4]; $textSame = [6];
