...
/* Graphics Options */
$accentStyles = [2, 3, 4, 6, 8, 10, 11, 12, 15]; //Styles that have an Accent
$accentCut = [3, 4, 6, 10, 11]; //Styles that have the Accent Cut-Out
$accentSame = [2, 8, 12, 15]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4, 6, 7, 8, 9, 10, 11, 12, 15, 16]; $textRef = 'CUSTOM TEXT/LOGO'; $textCut = [1, 2, 3, 6, 7, 8, 10, 11, 12, 15, 16]; $textSame = [4, 9];
