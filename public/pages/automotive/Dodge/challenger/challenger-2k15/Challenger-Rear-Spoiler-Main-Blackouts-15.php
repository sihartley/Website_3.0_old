 ...
 */
//$id = $_GET['id'];
$graphicId = 210; //Simon: Note: ID174 model='challenger' and year=2015
/**
...
/* Graphics Options */
$accentStyles = [2, 3, 4, 7]; //Styles that have an Accent
$accentCut = [3, 4, 7]; //Styles that have the Accent Cut-Out
