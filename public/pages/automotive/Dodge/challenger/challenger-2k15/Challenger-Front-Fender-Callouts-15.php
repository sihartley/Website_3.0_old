...
/* Graphics Options */
$accentStyles = [5, 6, 7, 8, 9, 10]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [6, 7, 8, 9, 10]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [6, 7, 8, 9, 10]; $textRef = 'TXT/LOGO'; $textCut = [6, 7, 8, 10]; $textSame = [9];
$text2 = []; $text2Ref = 'SIDE TXT/LOGO'; $text2Cut = []; $text2Same = [];
$text3 = []; $text3Ref = ''; $text3Cut = []; $text3Same = [];
$upperText = [1, 2, 3, 4]; $upperTextPlaceholder = 'Upper Text';
$lowerText = [1, 2, 3, 4]; $lowerTextPlaceholder = 'Lower Text';
                ...
                <?php formStart($design, $foxy_cart); ?>
                    ...
                    <!-- Graphic Section (material, color, accent, cutout options (trimOptions)) -->
                        <?php graphicInformationStart(); /* Closing </div> in textColorOptions */?>
                            ...
                            <?php mainColor($design, $upperText, $upperTextPlaceholder); ?>

                            <?php accentColor($design, $accentStyles, $accentCut, $accentSame, $lowerText, $lowerTextPlaceholder); // Accent Styles, Cut Styles, Same Styles ?>
