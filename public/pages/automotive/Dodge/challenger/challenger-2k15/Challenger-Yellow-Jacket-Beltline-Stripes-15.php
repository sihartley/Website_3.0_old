 ...
 */
//$id = $_GET['id'];
$graphicId = 271; //Simon: Note: ID224 model='challenger' and year=2015
/**
...
/* Graphics Options */
$accentStyles = [1, 4]; //Styles that have an Accent
$accentCut = [4]; //Styles that have the Accent Cut-Out
...
$text = [1, 2, 3, 4]; $textRef = 'CUSTOM TEXT/LOGO'; $textCut = [1, 2, 4]; $textSame = [3];
