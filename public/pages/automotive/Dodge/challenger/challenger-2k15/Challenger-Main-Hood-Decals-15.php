...
/* Graphics Options */
$accentStyles = [2, 5, 6, 14]; //Styles that have an Accent
$accentCut = [5, 6]; //Styles that have the Accent Cut-Out
$accentSame = [2, 14]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 3, 7, 12, 14]; $textRef = 'LOGO'; $textCut = []; $textSame = [1, 3, 7, 12, 14];
$text2 = [1, 2, 5, 7]; $text2Ref = 'TXTL'; $text2Cut = [1, 2, 5, 7]; $text2Same = [];
$text3 = [1, 2, 5, 7]; $text3Ref = 'TXTR'; $text3Cut = [1, 2, 5, 7]; $text3Same = [];
$trimData = null;
