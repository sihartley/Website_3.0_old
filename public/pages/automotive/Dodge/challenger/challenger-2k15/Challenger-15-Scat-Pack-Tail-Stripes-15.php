...
/* Graphics Options */
$accentStyles = [1, 3, 4, 5]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [1, 3, 4, 5]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4, 5]; $textRef = 'TXT/LOGO'; $textCut = [1, 2, 3]; $textSame = [4, 5];
