 ...
 */
//$id = $_GET['id'];
$graphicId = 251; //Simon: Note: ID224 model='challenger' and year=2015
/**
...
/* Graphics Options */
$accentStyles = [1]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [1]; //Styles that have the accent Separate which can be the Same Color as Main
...
$trimData = array(
    ...
    'Hood' => [
        ...
        'options' => [
            'standard' => [
                'text' => 'Standard Hood',
                'specs' => 'Usually Installed on Challenger SE, SXT, SXT PLus',
                'image' => '/Graphics/Vehicles/Dodge/Challenger/Challenger-2k15/Challenger_Standard_Hood.webp',
                'percentage' => 0
            ],
            'scat pack' => [
                'text' => 'Scat Pack Hood',
                'specs' => 'Usually Installed on Challenger R/T, Scat Pack, 392',
                'image' => '/Graphics/Vehicles/Dodge/Challenger/Challenger-2k15/Challenger_ScatPack_Hood.webp',
                'percentage' => 0,
                'add sub' => ''
            ],
            'hellcat' => [
                'text' => 'Hellcat Hood',
                'specs' => 'Usually Installed on Challenger Hellcat',
                'image' => '/Graphics/Vehicles/Dodge/Challenger/Challenger-2k15/Challenger_Hellcat_Hood.webp',
                'percentage' => 0,
                'add sub' => ''
            ],
            'redeye' => [
                'text' => 'Redeye Hood',
                'specs' => 'Usually Installed on Challenger Hellcat Redeye, Widebody Redeye',
                'image' => '/Graphics/Vehicles/Dodge/Challenger/Challenger-2k15/Challenger_Redeye_Hood.webp',
                'percentage' => 0,
                'add sub' => ''
            ],
            'shaker' => [
                'text' => 'Shaker Hood',
                'specs' => 'Usually Installed on Challenger Scat Pack Shaker',
                'image' => '/Graphics/Vehicles/Dodge/Challenger/Challenger-2k15/Challenger_Shaker_Hood.webp',
                'percentage' => 0,
                'add sub' => ''
            ],
            'demon' => [
                'text' => 'Demon Hood',
                'specs' => 'Usually Installed on Challenger Demon',
                'image' => '/Graphics/Vehicles/Dodge/Challenger/Challenger-2k15/Challenger_Demon_Hood.webp',
                'percentage' => 0,
                'add sub' => ''
            ]
        ]
