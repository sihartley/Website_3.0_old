...
/* Graphics Options */
$accentStyles = [2, 5, 6]; //Styles that have an Accent
$accentCut = [2]; //Styles that have the Accent Cut-Out
$accentSame = [5]; //Styles that have the accent Separate which can be the Same Color as Main
$accent2Styles = [3, 5, 4, 6]; //Styles with a 2nd Accent
$accent2Cut = [5]; //Styles that have the 2nd Accent Cut-Out
$accent2Same = [3, 4];  //Styles that have the 2nd Accent Separate which can be the Same Color as Main
$text = [1, 2, 4]; $textRef = 'CUSTOM TEXT/LOGO'; $textCut = [1, 2, 4]; $textSame = [];
