...
$accentSame = [2, 3, 4, 5]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4, 5, 6]; $textRef = 'CUSTOM TEXT/LOGO'; $textCut = [1, 2, 3, 4, 5, 6]; $textSame = [];
