...
/* Graphics Options */
$accentStyles = [21, 22, 23, 24]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [21, 22, 23]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [2, 3, 4, 5, 7, 8, 9, 10, 12, 13, 14, 15, 17, 18, 19, 20, 22, 23, 24]; $textRef = 'TEXT'; $textCut = []; $textSame = [2, 3, 4, 5, 7, 8, 9, 10, 12, 13, 14, 15, 17, 18, 19, 20, 22, 23, 24];
