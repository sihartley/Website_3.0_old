...
/* Graphics Options */
$accentStyles = [5]; //Styles that have an Accent
...
$text = [1, 2]; $textRef = 'CUSTOM / MOPAR'; $textCut = [1]; $textSame = [2];
$text2 = [1, 2, 3, 4]; $text2Ref = 'DESIGN /TEXT'; $text2Cut = [1, 3, 4]; $text2Same = [2];
