...
$accentSame = [3, 4]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4]; $textRef = 'CUSTOM TEXT/LOGO'; $textCut = [1]; $textSame = [2, 3, 4];
$text2 = [2, 3, 4]; $text2Ref = 'LOWER TXT/LOGO'; $text2Cut = [2, 3, 4]; $text2Same = [];
