...
/* Graphics Options */
$accentStyles = [5, 6, 7]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [6, 7]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [6, 7]; $textRef = 'TXT/LOGO'; $textCut = [6, 7]; $textSame = [];
