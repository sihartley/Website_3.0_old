...
/* Graphics Options */
$accentStyles = [5, 18, 19, 22, 23, 24]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [5, 18, 19, 22, 23, 24]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 3, 4, 5, 6, 7, 10, 14, 15, 16, 18]; $textRef = 'LOGO'; $textCut = []; $textSame = [1, 3, 4, 5, 6, 7, 10, 14, 15, 16, 18];
...
$trimData = array(
    'WashJets' => [
        'select' => [
            'name' => 'Washer Jets',
            'placeholder' => 'Pre-Cut for Washer Jets?'
        ],
        'options' => [
            'Pre-Cut' => [
                'text' => 'Yes, Pre-Cut for Washer Jet Nozzles',
                'specs' => 'We will pre-cut for washer jet nozzles, this can assist in alignment.',
                'image' => '',
                'percentage' => 0,
                'add sub' => ''
            ],
            'No Pre-Cut' => [
                'text' => 'No, Do Not Pre-Cut for Washer Jet Nozzles',
                'specs' => 'We will not pre-cut for washer jet nozzles, this give a more finished look.',
                'image' => '',
                'percentage' => 0,
                'add sub' => ''
            ]
