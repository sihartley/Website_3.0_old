...
/* Graphics Options */
$accentStyles = [7]; //Styles that have an Accent
$accentCut = [7]; //Styles that have the Accent Cut-Out
...
$text = [1, 2, 3, 4, 5, 6, 7]; $textRef = 'TEXT'; $textCut = [1, 7]; $textSame = [2, 3, 4, 5, 6];
