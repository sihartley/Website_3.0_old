...
/* Graphics Options */
$accentStyles = [4, 5, 10, 11]; //Styles that have an Accent
$accentCut = [5]; //Styles that have the Accent Cut-Out
$accentSame = [4, 10, 11]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 4, 16, 17]; $textRef = 'CUSTOM TEXT'; $textCut = [1, 4]; $textSame = [16, 17];
