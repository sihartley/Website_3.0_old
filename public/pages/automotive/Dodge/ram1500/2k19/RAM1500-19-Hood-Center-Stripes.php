 ...
 */
//$id = $_GET['id'];
$graphicId = 338; //Simon: Note: ID317 model='Grand Cherokee' and year=2011
/**
...
/* Graphics Options */
$accentStyles = [2, 4, 5, 6]; //Styles that have an Accent
$accentCut = [4, 6]; //Styles that have the Accent Cut-Out
$accentSame = [2, 5]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 4]; $textRef = 'TXT/LOGO'; $textCut = [1, 2, 4]; $textSame = [];
