...
$text = [1, 2]; $textRef = 'CUSTOM TEXT/LOGO'; $textCut = [1, 2]; $textSame = [];
$text2 = []; $text2Ref = 'RR DR TXT/LOGO'; $text2Cut = []; $text2Same = [];
...
$trimData = array(
        'Cab' => [
            ...
            'options' => [
                'Quad Cab (Small Rear Doors)' => [
                    'text' => 'Quad Cab (Small Rear Doors)',
                    'specs' => 'Quad Cab (Small Rear Doors) Installed on the vehicle',
                    'percentage' => 0,
                    'add sub' => '+'
                ],
                'Crew Cab (Full Rear Doors)' => [
                    'text' => 'Crew Cab (Full Rear Doors)',
                    'specs' => 'Crew Cab (Full Rear Doors) Installed on the vehicle',
                    'percentage' => .03,
                    'add sub' => '+'
                ]
            ]
        ...
        'Bed' => [
            ...
            'options' => [
                '5ft 7in Bed (Box)' => [
                    'text' => '5ft 7in Box (Bed)',
                    'specs' => 'Truck has 5ft 7in Box (Bed)',
                    'percentage' => 0,
                    'add sub' => '+'
                ],
                '6ft 4in Box (Bed)' => [
                    'text' => '6ft 4in Box (Bed)',
                    'specs' => 'Truck has 6ft 4in Box (Bed)',
                    'percentage' => .03,
                    'add sub' => '+'
                ]
            ]
