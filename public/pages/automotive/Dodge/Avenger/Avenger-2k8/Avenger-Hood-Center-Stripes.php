 ...
 */
//$id = $_GET['id'];
$graphicId = 64;//Simon: Not: Not Started
/**
...
/* Graphics Options */
$accentStyles = [3, 4, 5]; //Styles that have an Accent
$accentCut = [4]; //Styles that have the Accent Cut-Out
$accentSame = [3, 5]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 4]; $textRef = 'CUSTOM TEXT'; $textCut = [1, 4]; $textSame = [];
