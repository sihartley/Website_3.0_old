...
/* Graphics Options */
$accentStyles = [4, 5, 8]; //Styles that have an Accent
$accentCut = [5]; //Styles that have the Accent Cut-Out
$accentSame = [4, 8]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4, 5, 6, 8]; $textRef = 'CUSTOM TEXT'; $textCut = [1, 2, 3, 4, 5, 8]; $textSame = [6];
