...
/* Graphics Options */
$accentStyles = [3, 6, 9, 10, 14]; //Styles that have an Accent
$accentCut = [10, 14]; //Styles that have the Accent Cut-Out
$accentSame = [3, 6, 9]; //Styles that have the accent Separate which can be the Same Color as Main
