...
/* Graphics Options */
$accentStyles = [1, 3, 4, 6, 7, 8, 9, 11]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [1, 3, 4, 6, 7, 8, 9, 11]; //Styles that have the accent Separate which can be the Same Color as Main
$accent2Styles = [8, 11]; //Styles with a 2nd Accent
$accent2Cut = [8]; //Styles that have the 2nd Accent Cut-Out
$accent2Same = [11];  //Styles that have the 2nd Accent Separate which can be the Same Color as Main
$text = [1, 2, 3, 4, 6, 7, 11]; $textRef = 'CUSTOM TEXT/LOGO'; $textCut = [1, 2, 4, 7, 11]; $textSame = [4, 6];
