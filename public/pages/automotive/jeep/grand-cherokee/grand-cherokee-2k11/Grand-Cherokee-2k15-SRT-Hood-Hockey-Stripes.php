...
/* Graphics Options */
$accentStyles = [2, 3, 4]; //Styles that have an Accent
$accentCut = [2, 3]; //Styles that have the Accent Cut-Out
$accentSame = [6]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4, 5, 6]; $textRef = 'CUSTOM TEXT/LOGO'; $textCut = [1, 2, 3, 5, 6]; $textSame = [4];
