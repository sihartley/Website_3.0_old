...
/* Graphics Options */
$accentStyles = [2, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 16]; //Styles that have an Accent
$accentCut = [2, 6, 11, 13]; //Styles that have the Accent Cut-Out
$accentSame = [5, 8, 9, 10, 12, 14, 15, 16]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 4]; $textRef = 'YOUR CUSTOM LOGO'; $textCut = [1, 2, 4]; $textSame = [];
