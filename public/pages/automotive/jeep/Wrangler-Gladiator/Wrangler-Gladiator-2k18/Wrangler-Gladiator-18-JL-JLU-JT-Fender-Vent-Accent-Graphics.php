...
/* Graphics Options */
$accentStyles = [2, 3, 5, 6, 7, 8]; //Styles that have an Accent
$accentCut = [2, 3, 7, 8]; //Styles that have the Accent Cut-Out
$accentSame = [5, 6]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3]; $textRef = 'CUSTOM TEXT LOGO'; $textCut = [1, 2, 3]; $textSame = [];
