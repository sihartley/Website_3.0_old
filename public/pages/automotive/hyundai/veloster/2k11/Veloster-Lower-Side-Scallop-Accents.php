...
/* Graphics Options */
$accentStyles = [2, 6, 7]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [2, 6, 7]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 6, 7]; $textRef = 'CUSTOM TEXT'; $textCut = [1, 2, 6, 7]; $textSame = [];
