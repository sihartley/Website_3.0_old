...
/* Graphics Options */
$accentStyles = [2, 4, 5, 6, 7, 9]; //Styles that have an Accent
$accentCut = [4, 6]; //Styles that have the Accent Cut-Out
$accentSame = [2, 5, 7, 9]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4]; $textRef = 'CUSTOM'; $textCut = [1, 2, 4]; $textSame = [3];
