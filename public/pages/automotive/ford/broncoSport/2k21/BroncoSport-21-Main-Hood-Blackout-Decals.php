...
/* Graphics Options */
$accentStyles = [3, 4, 5, 9, 11, 12, 14, 15]; //Styles that have an Accent
$accentCut = [4, 5, 9, 14, 15]; //Styles that have the Accent Cut-Out
$accentSame = [3, 11, 12]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [5, 6, 7, 8, 9, 10, 11, 15]; $textRef = 'CUSTOM'; $textCut = [5]; $textSame = [6, 7, 8, 9, 10, 11, 15];
