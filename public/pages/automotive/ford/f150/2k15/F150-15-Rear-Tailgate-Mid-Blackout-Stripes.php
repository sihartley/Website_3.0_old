...
$trimData = array(
        'Emblem' => [
            'select' => [
                'name' => 'Emblem',
                'placeholder' => 'Pre-Cut for Emblem?'
            ],
            'options' => [
                'precut' => [
                    'text' => 'Yes, Pre-Cut for Emblem',
                    'specs' => 'We will pre-cut the graphic to fit around the emblem.',
                    'image' => '',
                    'percentage' => .0,
                    'add sub' => '-'
                ],
                'none' => [
                    'text' => 'No, Do Not Pre-Cut for Emblem',
                    'specs' => 'We will not pre-cut the graphic to fit around the emblem',
                    'image' => '',
                    'percentage' => 0,
                    'add sub' => ''
                ]
        ...
        'Tailgate' => [
            'select' => [
                'name' => 'Tailgate',
                'placeholder' => 'Tailgate Style?'
            ],
            'options' => [
                'standard' => [
                    'text' => 'Early Tailgate',
                    'specs' => 'Usually Installed on 2015-2017 Models',
                    'image' => '/Graphics/Vehicles/Ford/F-150/2k15/F150_Tailgate_2015_A.webp',
                    'percentage' => 0
                ],
                'scat pack' => [
                    'text' => 'Later Tailgate',
                    'specs' => 'Usually Installed on 2017-2020 Models',
                    'image' => '/Graphics/Vehicles/Ford/F-150/2k15/F150_Tailgate_2015_B.webp',
                    'percentage' => 0,
                    'add sub' => ''
                ]
            ]
