...
/* Graphics Options */
$accentStyles = [2, 3, 6]; //Styles that have an Accent
$accentCut = [3, 6]; //Styles that have the Accent Cut-Out
$accentSame = [2]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3]; $textRef = 'F150'; $textCut = [1, 2, 3]; $textSame = [];
$text2 = [1, 2, 3, 4, 5, 6]; $text2Ref = 'RR DR TEXT/LOGO'; $text2Cut = [1, 2, 3, 4, 5, 6]; $text2Same = [];
...
$trimData = array(
    'Cab' => [
        'select' => [
            'name' => 'Cab Style',
            'placeholder' => 'Cab Style?'
        ],
        'options' => [
            'Regular Cab (Two Door)' => [
                'text' => 'Regular Cab (Two Door)',
                'specs' => 'Regular Cab (Two Door) Installed on the vehicle',
                'percentage' => 0,
                'add sub' => '+'
            ],
            'SuperCab (Small Rear Doors)' => [
                'text' => 'SuperCab (Small Rear Doors)',
                'specs' => 'SuperCab (Small Rear Doors) Installed on the vehicle',
                'percentage' => .06,
                'add sub' => '+'
            ],
            'SuperCrew (Full Rear Doors)' => [
                'text' => 'SuperCrew (Full Rear Doors)',
                'specs' => 'SuperCrew (Full Rear Doors) Installed on the vehicle',
                'percentage' => .11,
                'add sub' => '+'
            ]
        ]
    ...
    'Bed' => [
        ...
        'options' => [
            '5ft 7in Bed (Box)' => [
                'text' => '5ft 6in Box (Bed)',
                'specs' => 'Truck has 5ft 6in Box (Bed)',
                'percentage' => 0,
                'add sub' => '+'
            ],
            '6ft 4in Box (Bed)' => [
                'text' => '6ft 6in Box (Bed)',
                'specs' => 'Truck has 6ft 6in Box (Bed)',
                'percentage' => .06,
                'add sub' => '+'
            ],
            '8ft Box (Bed)' => [
                'text' => '8ft Box (Bed)',
                'specs' => 'Truck has 8ft Box (Bed)',
                'percentage' => .15,
                'add sub' => '+'
            ]
        ]
