...
/* Graphics Options */
$accentStyles = [3, 4]; //Styles that have an Accent
$accentCut = [3, 4]; //Styles that have the Accent Cut-Out
...
$text = [1, 3, 4]; $textRef = 'CUSTOM'; $textCut = [1, 3, 4]; $textSame = [];
$text2 = [1, 3, 4]; $text2Ref = 'RR DR TEXT/LOGO'; $text2Cut = [1, 3, 4]; $text2Same = [];
