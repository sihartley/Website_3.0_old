...
/* Graphics Options */
$accentStyles = [2, 3]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [2, 3]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2]; $textRef = 'FR DR TEXT/LOGO '; $textCut = [1, 2]; $textSame = [];
$text2 = [1, 2]; $text2Ref = 'RR DR TEXT/LOGO'; $text2Cut = [1, 2]; $text2Same = [];
