 ...
 */
//$id = $_GET['id'];
$graphicId = 367; //Simon: Note: ID367 model='Fusion'
/**
...
$accentSame = [3, 6]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 5, 6]; $textRef = 'TEXT/LOGO'; $textCut = [1, 2, 3, 5, 6]; $textSame = [];
