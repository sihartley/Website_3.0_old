...
/* Graphics Options */
$accentStyles = [3, 4, 6]; //Styles that have an Accent
$accentCut = []; //Styles that have the Accent Cut-Out
$accentSame = [3, 4, 6]; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = [1, 2, 3, 4, 5, 6, 7]; $textRef = 'CUSTOM TEXT'; $textCut = [1, 4, 5, 6]; $textSame = [2, 3, 7];
$text2 = []; $text2Ref = 'SIDE TXT/LOGO'; $text2Cut = []; $text2Same = [];
$text3 = []; $text3Ref = ''; $text3Cut = []; $text3Same = [];
$trimData = array(
        'Bumpers' => [
            'select' => [
                'name' => 'Bumper Sections',
                'placeholder' => 'Include Bumper Sections?'
            ],
            'options' => [
                'installed' => [
                    'text' => 'Yes, Include Bumpers',
                    'specs' => 'Bumper Sections WILL be included.',
                    'image' => '',
                    'percentage' => .13,
                    'add sub' => '+'
                ],
                'none' => [
                    'text' => 'Don\'t include Bumper Sections',
                    'specs' => 'Bumper Sections will NOT be included.',
                    'image' => '',
                    'percentage' => 0,
                    'add sub' => ''
                ]
