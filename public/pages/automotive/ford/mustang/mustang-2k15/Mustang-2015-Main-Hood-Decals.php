...
/* Graphics Options */
$accentStyles = [2, 4, 5]; //Styles that have an Accent
$accentCut = [4, 5]; //Styles that have the Accent Cut-Out
...
$text = [1, 2, 4, 5, 6, 7]; $textRef = 'TEXT/LOGO'; $textCut = [1, 2, 4, 5]; $textSame = [6, 7];
