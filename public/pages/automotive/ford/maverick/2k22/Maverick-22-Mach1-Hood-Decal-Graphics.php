...
/* Graphics Options */
$accentStyles = [1, 2, 3]; //Styles that have an Accent
$accentCut = [1, 2, 3]; //Styles that have the Accent Cut-Out
$accentSame = []; //Styles that have the accent Separate which can be the Same Color as Main
$accent2Styles = [1, 2, 3]; //Styles with a 2nd Accent
$accent2Cut = [1, 2, 3]; //Styles that have the 2nd Accent Cut-Out
$accent2Same = [];  //Styles that have the 2nd Accent Separate which can be the Same Color as Main
$text = [1, 2, 3]; $textRef = 'CUSTOM'; $textCut = [1, 2]; $textSame = [3];
