...
require_once PRIV_PATH . '/functions/trailer_functions.php';
/**
 * @var $dbPrefix
...
$text = ['WSK', 'CKO', 'DBR', 'CKV', 'FTO', 'FSB', 'SFS', 'FST', 'RNV', 'SKW', 'TFSK']; $textRef = 'Custom Text Here'; $textCut = ['FSB'];
        $textSame = ['WSK', 'CKO', 'DBR', 'CKV', 'FTO', 'SFS', 'FST', 'RNV', 'SKW', 'TFSK'];
$text2 = ['CKO', 'FTO', 'FSB']; $text2Ref = 'Custom Lower Text'; $text2Cut = ['FSB']; $text2Same = ['CKO', 'FTO'];
$text3 = []; $text3Ref = ''; $text3Cut = []; $text3Same = [];

/* Page Options */
$css_file = '/css/designs.min.css'; // page css file
$page_title = "Custom Motorcycle Trailer Graphics."; // page title
?>
...
while ($graphic = mysqli_fetch_assoc($graphics)) {
    require PRIV_PATH . '/includes/trailer/trailer_variables.php';
    /**
     ...
     * @var $image_on $graphic['product_image_on'] disabled
     * @var $design_image $graphic['design_image']
     * @var $width_ratio $graphic['width_ratio']
     * @var $height_ratio $graphic['height_ratio']
     * @var $size_width_min $graphic['size_min']
     * @var $size_height_max $graphic['size_max']
    ...
    require ROOT.'/private/includes/trailer/trailer_graphic_while_start.php';
        ...
        <?php containerStart($product_name, $design, $graphic_design); ?>
            ...
            <!-- Form Start -->
                ...
                <!-- Initial (main) Product Inputs -->
                    <?php require ROOT.'/private/includes/trailer/trailer_graphic_form_initial_inputs.php' ?>
                ...
                <!-- Graphic Options Simon: ToDo: Graphic Change Option -->
                    <?php  ?>
