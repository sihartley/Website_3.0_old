...
/* Graphics Options */
$accentStyles = ['DBR', 'FSB']; //Styles that have an Accent
$accentCut = ['FSB']; //Styles that have the Accent Cut-Out
$accentSame = ['DBR']; //Styles that have the accent Separate which can be the Same Color as Main
...
$text = ['CKV', 'CKO', 'DBR', 'FBT', 'FTO', 'FST', 'FSB', 'SFS', 'WSK', 'RNK', 'TDP']; $textRef = 'Custom Main Text'; $textCut = ['FTO', 'TDP'];
    $textSame = ['CKV', 'CKO', 'DBR', 'FBT', 'FST', 'FSB', 'SFS', 'WSK', 'RNV'];
$text2 = ['CKO', 'FTO', 'FSB']; $text2Ref = 'Custom Lower Text'; $text2Cut = ['FTO', 'FSB']; $text2Same = ['CKO'];
$text3 = []; $text3Ref = ''; $text3Cut = []; $text3Same = [];

/* Page Options */
$css_file = '/css/designs.min.css'; // page css file
$page_title = "Customizable Motorcycle Gas Tank Graphics."; // page title
?>
