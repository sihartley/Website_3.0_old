...
$text = ['FE1', 'FE2', 'FE3', 'FE4', 'FE5', 'FE6']; $textRef = 'Custom Text Here'; $textCut = [];
    $textSame = ['FE1', 'FE2', 'FE3', 'FE4', 'FE5', 'FE6'];
...
$page_title = "Flaming Eagle Motorcycle Gas Tank Graphics."; // page title
?>
